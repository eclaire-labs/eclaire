...
CREATE TABLE "asset_processing_jobs" (
	...
	"user_id" text NOT NULL,
	"job_type" text DEFAULT 'processing',
...
CREATE UNIQUE INDEX "asset_jobs_asset_job_type_unique_idx" ON "asset_processing_jobs" USING btree ("asset_type","asset_id","job_type");--> statement-breakpoint
