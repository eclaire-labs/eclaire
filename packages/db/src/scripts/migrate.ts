...
// Get the directory of this script to resolve migration paths
const __filename = fileURLToPath(import.meta.url);
const __dirname = dirname(__filename);

// Migration folders relative to this script
const SQLITE_MIGRATIONS = resolve(__dirname, "../migrations/sqlite");
const POSTGRES_MIGRATIONS = resolve(__dirname, "../migrations/postgres");
