...
export const photos = sqliteTable(
	"photos",
	{
		...
		dominantColors: text("dominant_colors", { mode: "json" }).$type<DominantColors>(),
...
export const assetProcessingJobs = sqliteTable(
	"asset_processing_jobs",
	{
		...
		errorDetails: text("error_details", { mode: "json" }).$type<ErrorDetails>(),
...
export const history = sqliteTable(
	"history",
	{
		...
		beforeData: text("before_data", { mode: "json" }).$type<HistoryBeforeData>(),
