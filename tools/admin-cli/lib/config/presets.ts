...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  },
  {
    ...
    config: {
      ...
      auth: { type: 'bearer', requiresApiKey: true, envVar: 'OPENROUTER_API_KEY' }
    }
  },
  {
    id: 'openai',
  ...
  },
  {
    ...
    config: {
      ...
      auth: { type: 'header', requiresApiKey: true, envVar: 'ANTHROPIC_API_KEY' }
    }
  },
  {
    id: 'custom',
...
export function getPresetsForSelection(): ProviderPreset[] {
  ...
  const priority = ['llama-cpp', 'ollama', 'openrouter', 'lm-studio', 'mlx-lm', 'mlx-vlm'];
