...
export function AiSidebar({
  ...
  // Only highlight an agent if we're NOT showing a conversation in the main area
  const activeAgentId =
  ...
  const handleAgentClick = (
    ...
    // Always navigate, even if already on this agent's URL,
    // to ensure the chat view is dismissed and the agent page shows
    e.preventDefault();
