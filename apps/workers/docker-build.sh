...
# Eclaire Workers - Production Build

set -e

echo "🔨 Building Eclaire Workers (Production)..."


# Define constants
DOCKERFILE="Dockerfile"
BASE_IMAGE_TAG="eclaire-workers"
...
echo "Building Docker image with multi-stage build for production..."
docker build \
    -f "$DOCKERFILE" \
