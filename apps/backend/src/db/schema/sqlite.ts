...
export const tasks = sqliteTable(
  "tasks",
  {
    ...
    recurrenceEndDate: integer("recurrence_end_date", { mode: "timestamp_ms" }),
    recurrenceLimit: integer("recurrence_limit"),
    runImmediately: integer("run_immediately", { mode: "boolean" })
      .notNull()
      .default(false),
...
export const photos = sqliteTable(
  "photos",
  {
    ...
    iso: integer("iso"),
    fNumber: text("f_number"), // Stored as TEXT in SQLite
    exposureTime: text("exposure_time"), // Stored as TEXT in SQLite
    orientation: integer("orientation"),
    imageWidth: integer("image_width"),
    imageHeight: integer("image_height"),

    latitude: text("latitude"), // Stored as TEXT in SQLite
    longitude: text("longitude"), // Stored as TEXT in SQLite
    altitude: text("altitude"), // Stored as TEXT in SQLite
    ...
    dominantColors: text("dominant_colors", { mode: "json" }).$type<
      DominantColors
    >(),
...
export const assetProcessingJobs = sqliteTable(
  "asset_processing_jobs",
  {
    ...
    stages: text("stages", { mode: "json" }).$type<StageInfo[]>(),
...
export const channels = sqliteTable(
  ...
  (table) => ({
    ...
    // Note: SQLite doesn't support GIN indexes, removed configIdx
  }),
);
