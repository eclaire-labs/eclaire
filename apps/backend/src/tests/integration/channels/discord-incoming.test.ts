...
const { handleIncomingMessage } =
  await import("../../../../../../packages/channels/discord/src/incoming.js");
const { setDeps } =
  await import("../../../../../../packages/channels/discord/src/deps.js");
const { stopBot } =
  await import("../../../../../../packages/channels/discord/src/bot-manager.js");
const { getSession } =
  await import("../../../../../../packages/channels/discord/src/commands.js");
const { downloadFile } =
  await import("../../../../../../packages/channels/discord/src/voice-utils.js");
...
describe.each(DB_TEST_CONFIGS)(
  "$label - Discord Channel Integration",
  ({ dbType }) => {
