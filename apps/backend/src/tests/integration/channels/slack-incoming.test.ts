...
const { handleIncomingMessage, handleIncomingAudioFile } =
  await import("../../../../../../packages/channels/slack/src/incoming.js");
const { setDeps } =
  await import("../../../../../../packages/channels/slack/src/deps.js");
const { stopBot } =
  await import("../../../../../../packages/channels/slack/src/bot-manager.js");
const { getSession } =
  await import("../../../../../../packages/channels/slack/src/commands.js");
      ...
      it("notification-only channel: rejects audio", async () => {
        ...
        await handleIncomingAudioFile(
          ...
          "xoxb-fake-token",
          {
            ...
            name: "audio.webm",
            url_private_download:
              "https://files.slack.com/files-pri/audio.webm",
          },
          "C12345",
          "U67890",
          "ts-1",
